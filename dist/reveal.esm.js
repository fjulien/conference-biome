...
class k {
	...
	autoAnimateElements(e, t, i, s, a) {
		...
		if (
			...
			(e.className.match(b) || [""])[0] === (t.className.match(b) || [""])[0] &&
...
function K(n, o) {
		...
		if ((gt(), b && !1 !== R.autoSlide)) {
			...
			i
				...
				!_ ||
					...
					((J = setTimeout(() => {
						"function" == typeof R.autoSlideMethod ? R.autoSlideMethod() : Et(),
							ut();
					}, _)),
					(G = Date.now())),
				S && S.setPlaying(-1 !== J);
	...
	const Tt = {
		...
		initialize: function (e) {
			...
			if (((X.wrapper = n), (X.slides = n.querySelector(".slides")), !X.slides))
		...
		stopEmbeddedContent: () => Z.stopEmbeddedContent(b, { unloadIframes: !1 }),
		showPreview: Ne,
		hidePreview: Ie,

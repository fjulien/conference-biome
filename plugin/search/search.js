!((e, t) => {
	 ...
	 */ return () => {
		...
		function c(t, n) {
			const i = document.getElementById(t) || document.body;
			const o = n || "EM";
			const l = new RegExp(`^(?:${o}|SCRIPT|FORM)$`);
			...
			(this.setRegex = (e) => {
				...
				(this.remove = () => {
					for (
						let e, t = document.getElementsByTagName(o);
						t.length && (e = t[0]);
					)
